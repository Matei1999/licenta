  ...
  return (
    <div className={`flex gap-2 ${className || ''}`}>
      <select 
        ...
        required={required}
        className="form-select rounded-lg border border-gray-200 bg-white text-text-primary focus:ring-2 focus:ring-primary h-12 px-3 flex-1"
      >
      ...
      <select 
        ...
        required={required}
        className="form-select rounded-lg border border-gray-200 bg-white text-text-primary focus:ring-2 focus:ring-primary h-12 px-3 flex-[2]"
      >
